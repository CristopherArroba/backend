...
SECRET_KEY = 'django-insecure-xbm7$_&1@9vx%bte4=#f7ynq*pp%&#b4n8wlp=1#vfl#98+u=5'
...
firebase_admin.initialize_app(FIREBASE_CRED, {
    'databaseURL': 'https://landing-b4b12-default-rtdb.firebaseio.com/'
})
